...
public class TwelveHoursResolver implements CommandResolver {
    private final String COMMAND_NAME = "/twelveHours";

    public TwelveHoursResolver() {
    }
    ...
    public void resolveCommand(TelegramLongPollingBot tg_bot, String text, Long chatId) throws SQLException, TelegramApiException {
        ...
        FermaRepository.updateUserTime(String.valueOf(chatId), hours);
    }
